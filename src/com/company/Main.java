...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Third commit in release branch");
        System.out.println("Fourth commit in major_feature branch");
        System.out.println("Fourth commit in release branch");
